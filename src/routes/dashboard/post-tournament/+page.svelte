<main class="mx-auto max-w-3xl px-4 py-8">
	...
	<h1 class="mt-4 text-2xl font-bold text-white">Post-Tournament</h1>
	<p class="mt-1 text-gray-400">Generate graphics, make VOD public, upload to Braacket, sync to StartGG.</p>
